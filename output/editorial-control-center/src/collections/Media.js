...
export function getMediaStorageDirectoryName() {
  return readTrimmedEnv("MEDIA_STORAGE_DIR") || DEFAULT_MEDIA_STORAGE_DIR;
}

export function getMediaUploadMaxFileSizeBytes() {
...
export function resolveMediaStorageDirectory(projectRoot = process.cwd()) {
...
export function getMediaAdminThumbnail({ doc }) {
