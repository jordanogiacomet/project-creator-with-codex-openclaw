...
# ralph.sh — Story-by-story execution loop for Editorial Control Center
...
run_codex_retry() {
    ...
    # Build retry prompt without evaluating error text or story markdown in the shell
    {
        ...
        cat <<'PROMPT_EOF'
You are RETRYING a story that failed on the previous attempt for the project **Editorial Control Center**.
...
echo ""
echo "=== Ralph Loop: Editorial Control Center ==="
echo "Stories: $TOTAL"
